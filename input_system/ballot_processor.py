...
def standardise_ballot_styles(vote_ballots, ballot_styles):
    standardised_ballots_in_same_style = standardise_ballots(
        vote_ballots, ballot_styles)
    ballots_with_names_in_order = determine_preference_order_of_candidiates(
        standardised_ballots_in_same_style)
...
def standardise_ballots(vote_ballots, ballot_styles):
    ...
    for ballot in vote_ballots:
        ...
        standardised_ballot = convert_ballot_to_standard_ballot(
            ballot, this_ballot_style)
